...
<head>
    ...
    <style>
        body{
            background-image: url("image/daniel-frank-201417.jpg");
...
if(isset($_SESSION['custID'])){ ?>
    ...
    <div class="content">
        ...
        <img src="image/logo.jpg" height="120" style="float: left;margin-left: -17%;"><br><br><br>
        <form>
            <fieldset class="new">
                <br>
        ...
        <button style="width: 150px;" onclick="window.location.href='feedback.php'">Back</button><br>
    </div>
    </div>
    </div>
    <?php
