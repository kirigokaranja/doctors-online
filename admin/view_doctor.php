...
<div class="content">
    ...
    <h1 id="prof">View Doctors<h1>
            ...
            if(strpos($url,'error=fail')){
                ...
                echo "<p style='color:red; font-size:30px;text-align: center;'>Doctor Successfully Deactivated </p>";
            }elseif(strpos($url,'message=active')){
                echo "<p style='color:red; font-size:30px;text-align: center;'>Doctor Successfully Activated </p>";
            }
            ?>
            <button STYLE="width: 150px;font-size: 25px; float: right;" onclick="window.location.href='deactivated_doctors.php'">Deactivated Doctors</button>
            <br><br>
            <table>
                <tr>
                    <th>Doctor's No.</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="delete.php" method="post">
                            ...
                            <button type="submit" STYLE="width: 150px;font-size: 25px;margin-top: 2%"><img src='../image/rubbish.png' > Deactivate </button>
                        </form>
                    </td>
