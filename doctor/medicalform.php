...
<div class="topnav" id="myTopnav">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content" id="myDropdown">
            <a href="personal%20details.php">Personal Details</a>
    ...
    <div class="form">
        <form action="medicalform_action.php" method="post" enctype="multipart/form-data">
            <fieldset>
                ...
                &emsp;&emsp;&emsp;&ensp;<input type="text"  name="surname" placeholder="Surname"> <input type="text"  name="firstname" placeholder="Firstname"><br>
